 <div class="app-menu navbar-menu">
     ...
     <div class="navbar-brand-box mt-2">
         ...
         <a href="{{ route('home') }}" class="logo logo-dark">
             <img src="{{ asset('images/main_logo-modified.png') }}" alt="" height="22">
             <span class="logo-sm">
                 <img src="{{ asset('images/main_logo-modified.png') }}" alt="" height="22">
             </span>
             <span class="logo-lg">
                 <img src="{{ asset('images/main_logo-modified.png') }}" alt="" height="17">
             </span>
         </a>
         <!-- Light Logo-->
         <a href="{{ route('home') }}" class="logo logo-light">
             <span class="logo-sm">
                 <img src="{{ asset('images/main_logo-modified.png') }}" alt="" height="32">
             </span>
             <span class="logo-lg">
                 <img src="{{ asset('images/main_logo-modified.png') }}" alt="" height="80">
             </span>
         </a>
