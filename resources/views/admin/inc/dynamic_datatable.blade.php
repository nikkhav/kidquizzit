<div class="table-responsive">
    <table id="{{ $__datatableId }}" class="table table-striped table-bordered"  style="border-collapse: collapse; border-spacing: 0; width: 100%;">
    </table>
</div>
                    ...
                    buttons: [{
                        ...
                        className: 'btn btn-primary  arrow-none waves-effect waves-light create',
                            action: function ( e) {
                                ...
                                $('#profil-fotografi-goster').attr('src','https://png.pngtree.com/png-vector/20191009/ourlarge/pngtree-user-icon-png-image_1796659.jpg')
                            }
                        },
                    @endif
                        // {
